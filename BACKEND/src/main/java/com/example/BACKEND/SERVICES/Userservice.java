...
public class Userservice {
    ...
    public Outputwrapper register(Registerwrapper registerwrapper){
        ...
        user.setAdmin(registerwrapper.getAdmin());
        userrepo.save(user);
        ...
        output.setAdmin(registerwrapper.getAdmin());
        return output;
    }
    ...
    public ResponseEntity<?> deleteuser(Integer id) {
        ...
        boolean success = taskservice.deletetask(userrepo.getUsernamefromId(id));
